...
salaries$got_raised <- salaries$adjustments > 0
...
nrow(salaries[salaries$got_raised == TRUE, ])
...
mean(salaries[salaries$got_raised == FALSE, "adjustments"])
# or mean(salaries[salaries$got_raised == FALSE, ]$adjustments)
...
people_csv <- read.csv("relative/path/to/file", stringsAsFactors = FALSE)
